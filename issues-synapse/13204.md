---
number: 13204
title: "Testing with Complement has gotten so slow - 2 minutes to see test results"
state: "open"
author: "MadLittleMods"
created_at: "2022-07-06T19:57:19Z"
updated_at: "2023-10-18T10:09:12Z"
url: "https://github.com/matrix-org/synapse/issues/13204"
labels:
  - "T-Task"
  - "Z-Dev-Wishlist"
  - "A-Testing"
...
I used to be able to make a change in Synapse and see [Complement](https://github.com/matrix-org/complement) results after 20 seconds. Now it takes 1 minute 15 seconds just to build the Docker images at the start. And over 2 minutes to see the test results for running a single Complement test. This makes local dev such a pain :feelsgood: 
...
<details>
<summary>Complement run ./scripts-dev/complement.sh</summary>
...
@kegsay pointed out these couple issues which would also slow down single test runs (stopping and shutting down containers):
 ...
 - https://github.com/matrix-org/complement/pull/392
 - https://github.com/matrix-org/complement/pull/363
